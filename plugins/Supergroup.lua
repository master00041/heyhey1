...
local hash = 'group:'..msg.to.id
  local group_lang = redis.hget(hash,'lang')
  if group_lang then
  local text = "\n⚙<b>SuperGroup settings</b>⚙:\n____________________\n⚡️<b>Lock links</b> : "..settings.lock_link.."\n⚡️<b>Lock contacts</b>: "..settings.lock_contacts.."\n⚡️<b>Lock flood</b>: "..settings.flood.."\n⚡️<b>Flood sensitivity</b> : "..NUM_MSG_MAX.."\n⚡️<b>Lock spam</b>: "..settings.lock_spam.."\n⚡️<b>Lock Arabic</b>: "..settings.lock_arabic.."\n⚡️<b>Lock Member</b>: "..settings.lock_member.."\n⚡️<b>Lock RTL</b>: "..settings.lock_rtl.."\n⚡️<b>Lock Tgservice</b>: "..settings.lock_tgservice.."\n⚡️<b>Lock sticker</b>: "..settings.lock_sticker.."\n⚡️<b>Lock tag</b>: "..settings.tag.."\n⚡️<b>Lock emoji</b>: "..settings.emoji.."\n⚡️<b>Lock english</b>: "..settings.english.."\n⚡️<b>Lock Forward</b>: "..settings.fwd.."\n⚡️<b>Lock reply</b>: "..settings.reply.."\n⚡️<b>Lock join</b>: "..settings.join.."\n⚡️<b>Lock username</b>: "..settings.username.."\n⚡️<b>Lock media</b>: "..settings.media.."\n⚡️<b>Lock fosh</b>: "..settings.fosh.."\n⚡️<b>Lock leave</b>: "..settings.leave.."\n⚡️<b>Lock bots</b>: "..bots_protection.."\n⚡️<b>Lock operator</b>: "..settings.operator.."\n____________________\n⚙<b>Easy Sweet&Faster Switch</b>⚙:️\n____________________\n⚡️ <b>Switch Model Etehad</b>: "..settings.etehad.."\n⚡️<b>Lock all</b>: "..settings.all.."\n____________________\nℹ️<b>About Group</b>ℹ️:️\n____________________\n⚡️ <b>Group type</b>: "..gp_type.."\n⚡️<b>Public</b>: "..settings.public.."\n⚡️<b>Strict settings</b>: "..settings.strict.."\n____________________\n💥<b>Bot Version</b> : 1.0 💥\n💥<b>Maximus Bot</b>💥\n<b>Yaghi Team</b>\n<b>Channel</b>:@pedaret"
  return text
else
local text = "\n⚙<i>تنظیمات سوپرگروه</i>⚙:\n____________________\n⚡️<i>قفل لینک</i> : "..settings.lock_link.."\n⚡️<i>قفل شماره</i>: "..settings.lock_contacts.."\n⚡️<i>قفل فلود</i>: "..settings.flood.."\n⚡️<i>حساسیت فلود</i> : "..NUM_MSG_MAX.."\n⚡️<i>قفل اسپم</i>: "..settings.lock_spam.."\n⚡️<code>قفل متن عربی</code>: "..settings.lock_arabic.."\n⚡️<code>قفل اعضا</code>: "..settings.lock_member.."\n⚡️<i>قفلRTL</i>: "..settings.lock_rtl.."\n⚡️<i>قفل TGService</i>: "..settings.lock_tgservice.."\n⚡️<code>قفل استیکر</code>: "..settings.lock_sticker.."\n⚡️<i>قفل تگ</i>: "..settings.tag.."\n⚡️<i>قفل شکلک</i>: "..settings.emoji.."\n⚡️<code>قفل متن انگلیسی</code>: "..settings.english.."\n⚡️<code>قفل فوروارد متن</code>: "..settings.fwd.."\n⚡️<i>قفل ریپلای</i>: "..settings.reply.."\n⚡️<i>قفل پیوستن با لینک</i>: "..settings.join.."\n⚡️<code>قفل یوزرنیم</code>: "..settings.username.."\n⚡️<code>قفل پیام های چند رسانه ای</code>: "..settings.media.."\n⚡️<i>قفل فحش</i>: "..settings.fosh.."\n⚡️<i>قفل ترک گروه</i>: "..settings.leave.."\n⚡️<code>قفل ربات ها</code>: "..bots_protection.."\n⚡️<code>قفل اوپراتور</code>: "..settings.operator.."\n____________________\n⚙<i>سرعت بالا و امکانات عالی</i>⚙:️\n____________________\n⚡️ <i>قفل تنظیمات اتحاد</i>: "..settings.etehad.."\n⚡️<b>قفل همه</b>: "..settings.all.."\n____________________\nℹ️<i>ذرباره گروه</i>ℹ️:️\n____________________\n⚡️ <code>مدل گروه</code>: "..gp_type.."\n⚡️<code>عمومی</code>: "..settings.public.."\n⚡️<code>تنظیمات سخت گیرانه</code>: "..settings.strict.."\n____________________\n💥<i>ورژن ربات</i> : 5.1 💥\n💥<i>ربات ماکسیموس</i>💥\n<b>تیم یاغی</i>\n<b>کانال</i>:@pedaret"
  return text
end
end
...
local function run(msg, matches)
	...
	local data = load_data(_config.moderation.data)
		...
		if matches[1] == 'help' and not is_owner(msg) then
			text = "<b>Message /superhelp to @mega_maximus in private for SuperGroup help</b>"
